...
class _NavBarState extends State<NavBar> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: IndexedStack(
          index: tabIndex,
          children: const [HomeScreen(), CategoriesScreen(), CartScreen(), NotificationScreen(), ProfileScreen()]),
      ...
      floatingActionButton: SizedBox(
        ...
        child: FloatingActionButton(
          ...
          onPressed: () => Navigator
              .pushNamed(context,  RouteName.cartScreen,),
          child:  CustomImageView(svgPath: Assets.svgCart,height: 33.h,width: 33.w,),
        ),
      ),
...
itemBar(String icon, String label) {
  return BottomNavigationBarItem(icon: CustomImageView(svgPath: icon,height: 35.h,width: 35.w,fit: BoxFit.cover,), label: label);
}