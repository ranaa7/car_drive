...
import 'package:more_2_drive/presentation/widgets/shimmer/brands_shimmer.dart';
        ...
        return SizedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(
                height: 100.h,
                child: state is GetBrandsLoadingState||allBrands.isEmpty
                    ? const BrandsShimmer()
                    : ListView.separated(
                        ...
                        itemBuilder: (context, index) => InkWell(
                          onTap: () {
                            productCubit.getProductOfBrand(
                                id: allBrands[index].id, page: 1);
                            Navigator.pushNamed(
                                context, RouteName.productOfBrandScreen,
                                arguments: allBrands[index].id);
                          },
                          child: Container(
