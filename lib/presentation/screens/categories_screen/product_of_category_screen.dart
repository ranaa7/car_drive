...
class ProductOfCategoryScreen extends StatefulWidget {
  ...
  const ProductOfCategoryScreen({super.key, required this.id});

  @override
  State<ProductOfCategoryScreen> createState() =>
      _ProductOfCategoryScreenState();
}
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<ProductCubit, ProductState>(
      builder: (context, state) {
        ...
        final productDetails = ProductCubit.get(context).productOfCategory;
        ...
        return Scaffold(
            ...
            body: SmartRefresher(
              ...
              onLoading: () async {
                ...
                productCubit.getProductOfCategory(page: ++page, id: widget.id);
                          ...
                          ? List.generate(
                              ...
                              (index) => Padding(
                                    padding: EdgeInsets.symmetric(
                                        vertical: 50.0.h, horizontal: 5.w),
                                    child: InkWell(
                                      onTap: () {
                                      ...
                                      child: ProductItem(
                                        ...
                                        image:
                                            searchList[index].thumbnailImage ??
                                                '',
                                        discount:
