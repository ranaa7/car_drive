...
class AppStrings{
  ...
  static String get default1  => "default1".tr();
  static String get highToLow  => "highToLow".tr();
  static String get lowToHigh  => "lowToHigh".tr();
  static String get newArrival  => "newArrival".tr();
  static String get popularity  => "popularity".tr();
  static String get topRated  => "topRated".tr();
  static String get priceRange  => "priceRange".tr();
  static String get minimum  => "minimum".tr();
  static String get maximum  => "maximum".tr();
  ...
  static String get noAvailableProduct  => "noAvailableProduct".tr();
  static String get minMaxWarning  => "minMaxWarning".tr();
